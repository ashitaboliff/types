...
export const buildScheduleCreateRequestExample = () => {
	...
	return {
		...
		dates: [
			clock.isoDate(clock.daysFromToday(7)),
			clock.isoDate(clock.daysFromToday(14)),
		],
		mention: ['@all'],
		timeExtended: false,
...
export const buildScheduleResponseExample = () => {
	const clock = createExampleClock()
	return {
		id: 'sched_123',
		userId: 'user_mock_id',
...
export const buildScheduleUserExample = () => ({
	id: 'user_mock_id',
	name: 'モック太郎',
	image: 'https://example.com/users/mock-taro.png',
})

export const buildScheduleUserListExample = () => [
...
export const buildScheduleCreatedResponseExample = () => ({
	id: 'sched_created_1',
})

export const buildScheduleErrorExample = () => ({
	error: 'スケジュールの処理に失敗しました',
})
