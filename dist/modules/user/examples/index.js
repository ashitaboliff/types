import { pickPart, pickRole } from "../../../shared/examples/hepler.js";
import { createExampleClock } from "../../../shared/examples/index.js";

//#region src/modules/user/examples/index.ts
const buildUserExample = () => {
...
const buildUserProfilePayloadExample = () => ({
	name: "モック太郎",
	studentId: "21t0000a",
	expected: "26",
	role: pickRole(),
...
const buildUserSelectItemExample = () => ({
	id: "user_mock_id",
	name: "モック太郎",
	image: "https://example.com/avatar.png",
	profile: {
...
const buildUserSelectListExample = () => [buildUserSelectItemExample(), {
	id: "user_mock_2",
	name: "モック花子",
	image: null,
	profile: {
...
const buildUserQueryExample = () => ({
	sort: "new",
	page: 1,
	perPage: 10
});
const buildUpdateUserRoleExample = () => ({ role: "ADMIN" });
const buildUserDetailForAdminExample = () => {
	const clock = createExampleClock();
	return {
		id: "user_admin_1",
		name: "管理者太郎",
...
const buildUserListForAdminResponseExample = () => {
...
const buildUserErrorExample = () => ({ error: "ユーザーが見つかりませんでした" });
